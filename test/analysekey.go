...
func main() {
  ...
  if err1 == nil && key1 != nil { fmt.Fprintf(os.Stdout, "ParseECPrivateKey OK\n") }
  if err2 == nil && key2 != nil { fmt.Fprintf(os.Stdout, "ParsePKCS1PrivateKey OK\n") }
  if err3 == nil && key3 != nil { fmt.Fprintf(os.Stdout, "ParsePKCS8PrivateKey OK => %T\n", key3) }
}
